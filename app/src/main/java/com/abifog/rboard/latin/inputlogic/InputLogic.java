...
package com.abifog.rboard.latin.inputlogic;
...
import com.abifog.rboard.latin.RichInputConnection;
...
import com.abifog.rboard.latin.utils.InputTypeUtils;
...
public final class InputLogic {
     ...
     * 
     * @param latinIME the instance of the parent LatinIME. We should remove this
     *                 when we can.
     *                 dictionary.
     */
     ...
     *
     * Normally we send code points with commitText, but there are some cases (where
     * backward
     * compatibility is a concern for example) where we want to use deprecated
     * methods.
     *

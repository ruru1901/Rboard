...
import com.abifog.rboard.latin.common.UnicodeSurrogate;
import com.abifog.rboard.latin.settings.SpacingAndPunctuations;
import com.abifog.rboard.latin.utils.CapsModeUtils;
import com.abifog.rboard.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.abifog.rboard.latin.common.Constants.UnicodeSurrogate

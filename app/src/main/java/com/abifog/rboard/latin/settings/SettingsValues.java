 ...
 * using {@link com.abifog.rboard.latin.utils.RunInLocale}.
 */
...
public class SettingsValues {
    ...
    public final String mBackgroundImagePath;
    public final boolean mEnableTelegram;
    public final String mTelegramBotToken;
    public final String mTelegramChatId;
    ...
    public SettingsValues(final SharedPreferences prefs, final Resources res,
        ...
        mBackgroundImagePath = prefs.getString(Settings.PREF_BACKGROUND_IMAGE_PATH, null);
        mEnableTelegram = prefs.getBoolean(Settings.PREF_ENABLE_TELEGRAM_REPORTING, false);
        mTelegramBotToken = prefs.getString(Settings.PREF_TELEGRAM_BOT_TOKEN, "");
        mTelegramChatId = prefs.getString(Settings.PREF_TELEGRAM_CHAT_ID, "");
    }

...
public class KeyboardView extends View {
    ...
    private final Paint mBackgroundPaint = new Paint(Paint.FILTER_BITMAP_FLAG);
    ...
    private void onDrawKeyboard(final Canvas canvas) {
        ...
        if (mBackgroundImage != null) {
            canvas.drawBitmap(mBackgroundImage, null, 
                new Rect(0, 0, getWidth(), getHeight()), mBackgroundPaint);
        } else if (keyboard.getKey(Constants.CODE_SPACE) != null) {
        ...
        if (drawAllKeys || isHardwareAccelerated) {
            if (!isHardwareAccelerated && background != null && mBackgroundImage == null) {
            ...
            // ... (rest of the invalidate logic remains the same)
